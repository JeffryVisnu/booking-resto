            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="mt-10 w-1/2 space-y-8 divide-y divide-gray-200">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                        <input type="number" min="0.00" max="1000000.00" step="0.01" id="price" name="price" value="{{ $menu->price }}"
                    ...
                    <div class="pt-5 sm:col-span-6">
                        ...
                        <div class="mt-1">
                        <textarea id="body" name="description" rows="3" 
                        class="block w-full appearance-none rounded-md border border-gray-400 bg-white px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        {{ $menu->description }}
                        </textarea>
                        </div>
                    </div>
